...
export const PrinterSettingsModal: React.FC<PrinterSettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[10000015] bg-black/75 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4 overflow-y-auto animate-in fade-in duration-150">
      <div className="bg-white rounded-2xl sm:rounded-3xl max-w-2xl w-full p-3 sm:p-6 shadow-2xl space-y-3 sm:space-y-4 animate-in zoom-in-95 duration-150 border border-zinc-200 text-zinc-900 max-h-[94dvh] flex flex-col">
        {/* Header Modal */}
